...
class ResNet(nn.Module):
    def __init__(self, num_classes, input_channels, batch_size):
        ...
        # self.fcf = AngleLinear(1024,num_classes)
...
def resnet(num_classes, channels, batch_size):
    """
    Constructs a ResNet model.
    """
    return ResNet(num_classes, channels, batch_size)
